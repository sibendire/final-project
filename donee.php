...
if(isset($_POST['submit'])){
    ...
    $contact = $_POST['contact'];
       ...
       if(mysqli_num_rows($verify_query) != 0){
           ...
           mysqli_query($con, "INSERT INTO donation(DonorName, Email, Items,Number,Date,Location,Contact) VALUES('$donorName','$email','$items','$number','$date','$location','$contact')") or die("Error occurred while inserting data: " . mysqli_error($con));
           echo "<div class='message'>
